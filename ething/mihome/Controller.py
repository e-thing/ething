...
class Controller(object):
    ...
    def open(self):
        ...
        try:
            ...
            sock.setsockopt(socket.SOL_SOCKET,
                            socket.SO_RCVBUF, SOCKET_BUFSIZE)
            ...
            self.log.info("[Mihome]: connection opened, host: %s , port: %d" % (
                str(MULTICAST_ADDRESS), MULTICAST_PORT))
    ...
    def on_read(self):
        ...
        try:
            ...
            self.log.exception('unable to process : %s' % data)
