(function (factory) {
	// AMD.
	define(['jquery','ething','form','ui/widget', '//cdnjs.cloudflare.com/ajax/libs/noUiSlider/10.1.0/nouislider.min.js', 'css!//cdnjs.cloudflare.com/ajax/libs/noUiSlider/10.1.0/nouislider.min','ui/resourceselect','ui/devicerequest', 'ui/resourcedataselect'], factory);
}(function ($, EThing, Form, Widget, noUiSlider) {
