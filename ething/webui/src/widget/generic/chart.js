(function (factory) {
	// AMD.
	define(['require', 'jquery','ething','form','ui/widget','ui/resourceselect'], factory);
}(function (require, $, EThing, Form, Widget) {
		...
		instanciate: function(options){
			...
			options.sources.forEach(function(source){
				...
				if(resource.createdBy()){
					var createdByResource = EThing.arbo.findOneById(resource.createdBy());
