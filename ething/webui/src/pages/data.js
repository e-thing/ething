(function (root, factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        define(['require', 'ui/core', 'text!./data.html', 'jquery', 'ething', 'ui/infopanel', 'ui/droppable', 'ui/uploader', 'ui/browser','css!./data', 'jquery-mobile-events', 'ui/formmodal', 'css!font-awesome'], factory);
    }
}(this, function (require, UI, template, $, EThing, Infopanel, Droppable, Uploader) {
	...
	return {
		...
		buildView: function(data){
			...
			$element.find('#btn-create-file').click(function(){
				...
				var form = UI.meta.getResourceForm('File', ['name','description']).then(function(formEntries){
			...
			$element.find('#btn-create-table').click(function(){
				...
				require(['csv'], function(CSV){
					...
					UI.meta.getResourceForm('Table', ['name','description']).done(function(formEntries){
