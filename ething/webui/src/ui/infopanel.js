(function (root, factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        define(['jquery','ething','ui/core','text!ui/infopanel.html','css!ui/infopanel','bootstrap','ui/browser'], factory);
    }
}(this, function ($, EThing, UI, template) {
	
	
	console.log('loading ui/infopanel.js');
	...
	var Infopanel = {
		...
		setResource: function(resource,forceUpdate){
			...
			if(multiple){
				...
				props = UI.meta.get(resource, 'properties');
