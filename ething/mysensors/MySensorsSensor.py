...
@attr('sensorId', validator = isInteger(min=0, max=254))
@attr('sensorType', validator = (isString(allow_empty=False) | isInteger(min=0)) & isSensorType(), model_adapter = SensorTypeAdapter())
