...
valueTypes = {
    ...
    'V_FORECAST': (5, "forecast", 'string', True),
    ...
    'V_DIRECTION': (10, "wind direction", 'float', True),
    ...
    'V_KWH': (18, "KWH", 'float', True),
    # Turn on a scene, the payload contains the scene id
    'V_SCENE_ON': (19, None, 'int', True),
    # Turn off a scene, the payload contains the scene id
    'V_SCENE_OFF': (20, None, 'int', True),
    # Mode of header. One of "Off", "HeatOn", "CoolOn", or "AutoChangeOver"
    'V_HVAC_FLOW_STATE': (21, "flow state", 'string', True),
    # HVAC/Heater fan speed ("Min", "Normal", "Max", "Auto")
    'V_HVAC_SPEED': (22, "speed", 'string', True),
    # Uncalibrated light level. 0-100%. Use V_LEVEL for light level in lux.
    'V_LIGHT_LEVEL': (23, "light", 'float', True),
    'V_VAR1': (24, "var1", '*', True),
    'V_VAR2': (25, "var2", '*', True),
    'V_VAR3': (26, "var3", '*', True),
    'V_VAR4': (27, "var4", '*', True),
    ...
    'V_LOCK_STATUS': (36, "status", 'bool', True),
    ...
    'V_RGB': (40, "color", (RGB_encoder, RGB_decoder), True),
    # RGBW value transmitted as ASCII hex string (I.e "ff0000ff" for red + green + blue + full white)
    'V_RGBW': (41, ("color", "level"), (RGBW_encoder, RGBW_decoder), True),
    ...
    'V_UNIT_PREFIX': (43, "unit", 'string', False),
    ...
    'V_HVAC_FLOW_MODE': (46, "flow mode", 'string', True),
