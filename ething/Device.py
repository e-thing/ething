 		...
 		{  
 		   ...
 		   "properties":{
             ...
             "extends": {
 		          ...
 		          "description":"A list of classes this device inherit",
 		          "readOnly": true
 		       }
 		   }
 		}
...
@attr('battery', validator = isNone() | isInteger(min=0, max=100), default = None) # 0-100 : the battery level, if None it means that no battery information is provided
@attr('location', validator = isNone() | isString(), default = None)
@attr('connected', validator = isBool(), default = False)
@attr('lastSeenDate', validator = isNone() | isInstance(datetime.datetime), default = None)
@attr('methods', default = [], mode = READ_ONLY)
@attr('interfaces', default = [], mode = READ_ONLY)
