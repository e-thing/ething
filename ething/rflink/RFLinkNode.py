...
@attr('nodeId', validator = isString(allow_empty=False))
@attr('subType', validator = isString() & isEnum(RFLink.subTypes))
@attr('protocol', validator = isString(allow_empty=False))
@attr('switchId', validator = isNone() | isString(allow_empty=False))
