...
def test_toJson():
    ...
    assert toJson(obj_ext, fields = ('key1', 'key2'), sort_keys=True) == json.dumps(obj, sort_keys=True)
    ...
    assert toJson(arr_ext, fields = ('key1', 'key2'), sort_keys=True) == json.dumps(arr, sort_keys=True)
