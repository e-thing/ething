(function (root, factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        define(['js/ui', 'jquery', 'ething', 'json!widget/devices/map.json', 'css!./dashboard', 'form', 'resourceselect', 'ui/modal', 'jquery.gridster'], factory);
    }
}(this, function (UI, $, EThing, DevMap) {
		...
		return {
			...
			/*loadMap: function(){
				...
				if(map===null){
					...
					require(['json!'+this.map], function(m){
						map = m;
						dfr.resolve(map);
					}, function(){
						dfr.reject('map not found !');
					});
			...
			instanciate: function(name, options, device){
				...
				return this.load(name).then(function(plugin){
