(function (root, factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        define(['js/ui', 'text!./devices.html', 'jquery', 'ething','ui/infopanel', 'browser', 'css!./devices', 'formmodal', 'css!font-awesome'], factory);
    }
	...
	return {
		...
		buildView: function(){
			...
			$element.find('#btn-create-MySensorsNode').click(function(){
				...
				require(['resourceselect'], function(){
					UI.getResourceForm('Device\\MySensorsNode', null, ['name','location','description','nodeId','smartSleep']).done(function(formEntries){
